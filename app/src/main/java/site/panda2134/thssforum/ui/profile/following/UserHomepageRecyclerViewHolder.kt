...
import cn.bingoogolapple.photopicker.imageloader.BGAImage.pause
...
import site.panda2134.thssforum.databinding.HomepagePostItemBinding
...
class UserHomepageRecyclerViewHolder(val binding: HomepagePostItemBinding, val api: APIWrapper): RecyclerView.ViewHolder(binding.root), BGANinePhotoLayout.Delegate {
